...
LOCAL_SPATIAL_ANALYSIS_FILENAME = "spatial_analysis_full.pkl"
...
def refined_parameter_snapshot() -> dict[str, Any]:
    return {
        ...
        "merged_data_filename": CLUSTER_REFINED_INPUT_FILENAME,
        "local_spatial_analysis_filename": LOCAL_SPATIAL_ANALYSIS_FILENAME,
        "cluster_spatial_classification_filename": CLUSTER_SPATIAL_CLASSIFICATION_FILENAME,
